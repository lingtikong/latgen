...
void BCC::BCC001()
{
  ...
  case 1:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "BCC001_atpos");
...
void BCC::BCC110()
{
  ...
  case 1:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "BCC110_atpos");
    attyp = new int[nucell];
...
void BCC::BCC111()
{
  ...
  case 1:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "BCC111_atpos");
    attyp = new int[nucell];
