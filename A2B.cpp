...
A2B::A2B() : lattice()
{
  ...
  if (count_words(gets(str)) > 0) sscanf(str,"%d", &ctype);
...
void A2B::A2B_C1()
{
  ...
  case 1:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C1_001_atpos");
  ...
  case 3:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C1_110_atpos");
    attyp = new int[nucell];
  ...
  case 4:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C1_111_atpos");
    attyp = new int[nucell];
  ...
  case 5:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C1_primitive_atpos");
    attyp = new int[nucell];
...
void A2B::A2B_C15()
{
  ...
  case 1:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C15_001_atpos");
    attyp = new int[nucell];
  ...
  case 3:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C15_110_atpos");
    attyp = new int[nucell];
  ...
  case 4:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C15_111_atpos");
    attyp = new int[nucell];
  ...
  case 5:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C15_primitive_atpos");
    attyp = new int[nucell];
...
void A2B::A2B_C32()
{
  ...
  case 1:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C32_001_atpos");
    attyp = new int[nucell];
  ...
  case 3:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C32_100_atpos");
    attyp = new int[nucell];
  ...
  case 4:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C32_110_atpos");
    attyp = new int[nucell];
  ...
  case 5:
    ...
    atpos = memory->create_2d_double_array(nucell, 3, "A2B_C32_(1-10)_atpos");
    attyp = new int[nucell];
